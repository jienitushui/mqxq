...
public class CaptchaConfig {
     ...
     * 创建验证码Bean
     * 
     * 配置Kaptcha验证码生成器，设置验证码样式为数学运算题
     * 包括边框、颜色、字体、图片尺寸等详细配置
     * 
    ...
    public DefaultKaptcha getCaptchaBeanMath() {
        ...
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "com.jieni.mqxq.common.config.CaptchaTextCreator");
        // 验证码文本字符间距 默认为2
